...
Reason: ${e4}`);
  ...
  // sdk-entry.mjs
  var sdk_entry_exports = {};
  __export(sdk_entry_exports, {
    Vapi: () => import_web.default,
    default: () => sdk_entry_default
  });
  var import_web = __toESM(require_vapi(), 1);
  var sdk_entry_default = import_web.default;
  return __toCommonJS(sdk_entry_exports);
})();
